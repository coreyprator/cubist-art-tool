...
def test_enhanced_cascade_fill():
    ...
    # Test parameters
    test_cases = [
        {"geometry": "delaunay", "points": 100, "desc": "Delaunay triangulation with spatial optimization"},
        {"geometry": "voronoi", "points": 80, "desc": "Voronoi cells with adjacency-based placement"},
        {"geometry": "rectangles", "points": 120, "desc": "Rectangles with rotational variety"},
    ]
    ...
    try:
        ...
        print(f"✅ SUCCESS: Regular tessellation completed")
    ...
    print(f"   Look for:")
    print(f"   - Better space utilization (fewer gaps)")
    print(f"   - Adjacency-based placement (shapes near each other)")
    print(f"   - Variety in shape sizes and orientations")
